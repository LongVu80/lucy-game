...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('hero-pivot', 'assets/hero/pivot.png', {
      frameWidth:32,
      frameHeight: 64,
    });
    ...
    this.load.spritesheet('hero-flip', 'assets/hero/spinjump.png', {
      frameWidth:32,
      frameHeight: 64,
    });

    this.load.spritesheet('hero-fall', 'assets/hero/fall.png', {
      frameWidth:32,
      frameHeight: 64,
    });

    this.load.spritesheet('hero-die', 'assets/hero/bonk.png', {
      frameWidth:32,
      frameHeight: 64,
    });
  }
  ...
  create(data) {
    ...
    this.anims.create({
      key: 'hero-pivoting',
      frames: this.anims.generateFrameNumbers('hero-pivot'),
    ...
    this.anims.create({
      key: 'hero-flipping',
      frames: this.anims.generateFrameNumbers('hero-flip'),
      frameRate: 30,
      repeat: -1,
    });
    ...
    this.anims.create({
      key: 'hero-falling',
      frames: this.anims.generateFrameNumbers('hero-fall'),
      frameRate: 10,
      repeat: -1,
    });
    ...
    this.anims.create({
      key: 'hero-dead',
      frames: this.anims.generateFrameNumbers('hero-die'),
    });
  ...
  addHero() {
    ...
    const spikeCollider = this.physics.add.overlap(this.hero, this.spikeGroup, () => {
      this.hero.kill();
    });
  ...
  addMap() {
    ...
    backgroundLayer.setScrollFactor(.6);
